...
@interface AllCityNameController ()<UITableViewDataSource,UITableViewDelegate>

@end

@implementation AllCityNameController
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    if(indexPath.section == 0) {
        ZAHotCityCell *cell = [ZAHotCityCell cellWithTableView:tableView HotCitArray:self.arrayHotCity];
        return cell;
    } else {
